# Tareas y Features por completar
...
- diseño completo del dashboard de los usuarios comunes. 
- permitir tanto al usuario administrador como a los usuarios comunes editar sus atributos de perfil ('name', 'email', la password al ser unica y dada por el gerente de la farmacia, no se puede modificar, solo el administrador puede modificar el completo de sus atributos).