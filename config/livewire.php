...
return [
    ...
    */
    ...
    'disk' => null,        // El disco por defecto (suele ser 'local')
    'rules' => null,       // Reglas globales
    'directory' => null,   // Carpeta temporal
    'middleware' => null,  // Middleware de subida
    'preview_mimes' => [   // <--- ESTA ES LA LISTA QUE DEBES EDITAR
        'png', 'gif', 'bmp', 'svg', 'wav', 'mp4',
        'mov', 'avi', 'wmv', 'mp3', 'm4a',
        'jpg', 'jpeg', 'mpga', 'webp', 
        'pdf', // <--- AGREGA ESTO AQUÍ
    ],
    'max_upload_time' => 5, // Tiempo máximo de subida
    ],
